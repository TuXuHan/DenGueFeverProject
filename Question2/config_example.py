"""
登革熱疫情資料系統 - 範例設定檔
這是一個範例設定檔,展示如何自訂系統的各種參數
複製此檔案為 config.py 並根據需要修改設定
"""
...
FASTAPI_CONFIG = {
    ...
    "host": "0.0.0.0",  # 改為 "127.0.0.1" 僅允許本機訪問
    "port": 8000,       # 可修改為其他端口
    "reload": True,     # 開發時設為 True,生產環境設為 False
}
...
# 地圖基本設定
MAP_CONFIG = {
    # 地圖中心點 (可修改為其他城市座標) - 當 use_dynamic_center 為 False 時使用
...
# 頁面標題和文字
UI_TEXT = {
    "page_title": "台南市登革熱疫情資料",  # 可修改為其他標題
    "sidebar_title": "行政區列表",
...
# Selenium 設定
SELENIUM_CONFIG = {
    "headless": True,          # 設為 False 可以看到瀏覽器視窗
    "wait_timeout": 3,         # 等待超時時間
    "scroll_delay": 0.5,       # 滾動延遲
...
SECURITY_CONFIG = {
    "cors_origins": ["*"],   # 生產環境建議限制特定域名
    "cors_methods": ["GET", "POST", "PUT", "DELETE"],
    "cors_headers": ["Content-Type"],
    "rate_limit": {
        "enabled": False,    # 生產環境建議啟用
...
DEBUG_CONFIG = {
    "debug_mode": False,     # 開發時設為 True
    "auto_reload": True,     # 生產環境設為 False
    "show_error_details": True,  # 生產環境設為 False
...
# 範例:如何為其他城市自訂設定
# if you want to use this system for other cities:

# CUSTOM_CITY_CONFIG = {
#     "city_name": "台南市",
#     "center": [23.1267, 120.3700],  # 台南市座標
#     "data_sources": {
#         "city_data_url": "https://data.tainan.gov.tw/...",
#         "data_titles": ["台南市相關資料"],
#     },
#     "coordinate_system": {
#         "input_crs": "EPSG:3826",
